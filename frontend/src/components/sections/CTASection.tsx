...
const CTASection: React.FC = () => {
  return (
    <div className="relative overflow-hidden bg-gradient-to-r from-amber-600 via-orange-600 to-yellow-600 rounded-3xl shadow-2xl">
          ...
          >
            ...
            <Link to="/register">
              <Button 
                size="lg" 
                variant="secondary" 
                className="!bg-white !text-amber-700 hover:!bg-amber-50 shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300"
              >
